...
if (function_exists('as_unschedule_all_actions')) {
    as_unschedule_all_actions('sccc_run_manual_sync', [], 'seo-content-control-center');
    as_unschedule_all_actions('sccc_run_incremental_sync', [], 'seo-content-control-center');
    as_unschedule_all_actions('sccc_run_local_audit', [], 'sccc');
    as_unschedule_all_actions('sccc_run_scheduled_local_audit', [], 'sccc');
}
