...
- Google Search Console connections belong to a site; read APIs expose only account, property, connection, and disconnect timestamps while keeping `encryptedRefreshToken` out of responses.
