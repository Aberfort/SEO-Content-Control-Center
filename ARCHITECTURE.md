...
The core MVP architecture is implemented, while final release certification and some post-launch/enterprise capabilities remain. As of Iteration 111 the codebase stands as follows:
