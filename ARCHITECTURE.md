...
The core MVP architecture is implemented, while production server smoke, final release certification, and some post-launch/enterprise capabilities remain. As of Iteration 110 the codebase stands as follows:
