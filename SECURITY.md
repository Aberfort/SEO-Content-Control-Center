...
- Release packaging verifies a single plugin root and excludes tests, Composer lockfiles, development dependencies, and coding-standard configuration from installable WordPress zip artifacts.
